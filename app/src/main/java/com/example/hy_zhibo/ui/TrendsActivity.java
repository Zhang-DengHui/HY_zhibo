package com.example.hy_zhibo.ui;
...
import com.example.biyingxiangmu.adapter.TrendsPublishAdapter;
import com.example.biyingxiangmu.base.BaseActivity;
import com.example.biyingxiangmu.bean.PublishTrendsBean;
import com.example.biyingxiangmu.bean.SaveDataBean;
import com.example.biyingxiangmu.bean.TrendsVo;
...
import com.example.biyingxiangmu.presenter.TrendsPersenter;
...
public class TrendsActivity extends BaseActivity<TrendsStract.Persenter> implements TrendsPublishAdapter.OpenPhoto, TrendsStract.View {
    ...
    @Override
    protected TrendsStract.Persenter initPresenter() {
    ...
    private void sendTrends(){
        ...
        presenter.sendTrends(content,stringBuilder.toString());
    }
